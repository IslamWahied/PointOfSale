...
namespace PointOfSaleSedek._101_Adds
{
    ...
    public partial class frmBackOfficeDashBord : DevExpress.XtraEditors.XtraForm
    {
        readonly POSEntity context = new POSEntity();
        Static st = new Static();
        public frmBackOfficeDashBord()
        {
            InitializeComponent();
        ...
        public void Fill_BackOffice_Gride()
        {
            ...
            try
            {
                ...
                var ItemTransactions = _server.BackOfficeTranDetail_View.Where(x => x.IsDeleted == 0).ToList();
        ...
        private void gvItemCard_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            ...
            {
                if (  e.Column.FieldName == "Fail_Take_Update_Reason")
                    e.Appearance.BackColor = Color.Yellow;
            }
            else if (state == "Approved" && !string.IsNullOrWhiteSpace(state))
            {
        ...
        private void windowsUIButtonPanel_ButtonClick_1(object sender, ButtonEventArgs e)
        {
            ...
            if (btn.Caption == "Refersh" || btn.Caption == "تحديث")
            {
